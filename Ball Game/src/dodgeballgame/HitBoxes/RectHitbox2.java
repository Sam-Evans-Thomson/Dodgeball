 ...
 * @author Sam
 */
public class RectHitbox2 extends Hitbox{
    
    LineHitbox left,right,up,down;
    
    public RectHitbox2(double x, double y, double w, double h) {
        super(x,y);
        this.w = w;
        this.h = h;
        shape = RECT;
    ...
    public RectHitbox2(double x, double y, double x2, double y2, int i){
    ...
    public RectHitbox2(Vec2 pos, double w, double h) {
        super(pos);
        this.w = w;
        this.h = h;
        shape = RECT;
    ...
    public RectHitbox2(double x, double y) {
        super(x,y);
        shape = RECT;
        setLines();
    }
    
    public RectHitbox2(Vec2 pos) {
        super(pos);
        shape = RECT;
        setLines();
    }
    ...
    public LineHitbox getLine2(Vec2 prevPos, Vec2 pos) {
